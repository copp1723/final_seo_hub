...
export function AutomotiveSEOChat({ dealershipInfo }: { dealershipInfo?: DealershipInfo }) {
  ...
  const handleSend = async () => {
    console.log('🚀 handleSend called', { input, isLoading, inputTrimmed: input.trim() })
    ...
    try {
      console.log('🌐 Making API request to /api/chat/automotive')
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {messages.map((message) => (
          <div key={message.id}>
            ...
            <form
              onSubmit={(e) => {
                console.log('📝 Form submitted', { input, isLoading })
                e.preventDefault();
                handleSend();
              }}
            ...
            >
              ...
              <Button
                ...
                onClick={() => console.log('🔘 Button clicked', { input, isLoading, disabled: isLoading || !input.trim() })}
              >
