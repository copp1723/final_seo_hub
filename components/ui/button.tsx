...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', disabled, asChild = false, ...props }, ref) => {
    ...
    const variants = {
      default: 'bg-gradient-brand text-white shadow-lg shadow-brand-medium/25 hover:shadow-xl hover:shadow-brand-medium/40 hover:bg-gradient-brand-hover border border-brand-medium/20 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98]',
      primary: 'bg-gradient-brand text-white shadow-lg shadow-brand-medium/25 hover:shadow-xl hover:shadow-brand-medium/40 hover:bg-gradient-brand-hover border border-brand-medium/20 hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98]',
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-medium/30 focus-visible:ring-offset-2',
